export const projects = [
  {
    ...
    tags: ["Python", "Image analysis", "Science", "Numpy", "Pandas", "App dev"],
    description:
    ...
    imageLink: "images/SimpliPyTEM-image2.png",
    blogId: null,
    PhD: true,
    externalLink: "https://simplipytem.readthedocs.io/en/latest/",
    linkButton: "View Project Docs",
  },
  {
    id: 5,
    ...
    imageLink: "images/CanoePoloWhiteboard.gif",
    blogId: null,
    ...
    linkButton:"Try it out!"
  },
  {
    id: 4,
    title: "Project San Marino",
    subtitle: "A virtual exercise challenge between Edinburgh and San Marino",
    tags: ["Data visualisation", "Python", "Dashboard"],
    imageLink: "images/Example_dash.png",
    blogId: null,
...

  {
    ...
    imageLink: "images/MeWithMicroscope.jpeg",
    blogId: null,
    description: `
  ...
  },
  {
    ...
    imageLink: "images/CTF_simulation.gif",
    blogId: null,
    description:
...

  {
    ...
    tags: ["JavaScript","three.js",  "3D modelling","Web dev",],
    imageLink: "images/CanoePolo3D.gif",
    blogId: null,
    description:
  ...
  },
  {
    ...
    tags: ["JavaScript","d3.js", "UI", "Web dev",],
    imageLink: "images/ColorPaletteGenerator.png",
    blogId: null,
    description:
  ...
  },
  {
    ...
    tags: ["Java", "App dev"],
    imageLink: "images/gameExample.png",
    blogId: null,
...
This project turned out to be fairly straight-forward (took a couple of days), but I really enjoyed making it!`,
    ...
    linkButton:"View Repository"
  },
  {
    id: 9,
    title: "GPT shopping list generator",
    subtitle: "Enter some recipe web-pages and it will return a shopping list!",
    tags: ["Python", "LLM", "GPT", "Web-scraping", "App dev"],
    imageLink: "images/shoppingListGenerator.png",
    blogId: null,
    description:
      "I made a lightweight python application which uses the OpenAI API to parse links to recipe webpages, finds the ingredients and outputs a sorted shopping list.",
    PhD: true,
    externalLink: null,
